...
from knowledgeforge.server.models import RequestContext, normalize_completion_mode
from knowledgeforge.server.utils.query_normalization import FALLBACK_ABBREVIATIONS, FALLBACK_DISPLAY_NAMES
from knowledgeforge.server.utils.knowledge_tree import normalize_core_topics
...
class ContextBuilder:
    def build(self, payload: dict[str, object]) -> RequestContext:
        ...
        return RequestContext(
            ...
            structure_mode="pending_structure_graph",
            navigation_targets=[],
            knowledge_blueprint=[],
            required_files=[],
