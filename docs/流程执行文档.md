...
`completion_mode=full_document` 时，此步骤仍先生成架构文档；完整知识文档在后置补全文档动作中生成。
...
- `framework` 是默认和必须产物；Web UI 不在 intake 阶段选择完整文档；“补全文档”按钮会先检查框架、证据队列和治理状态，确认完成后再逐个补全文档。
